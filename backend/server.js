...
// ── CORS — set headers manually (most reliable approach) ──────────
app.use((req, res, next) => {
  const origin = req.headers.origin;
  // Allow any onrender.com domain + localhost
  if (!origin || origin.endsWith('.onrender.com') || origin.startsWith('http://localhost')) {
